#pragma once
#ifndef SCIENCE_MATH_H
#define SCIENCE_MATH_H
...
float frequencyToEnergy(float frequency, bool print = false) {
    if (print)
        std::cout << frequency * planckConst << std::endl;
    return frequency * planckConst;
}
#endif
